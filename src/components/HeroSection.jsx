      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">
            Full-stack developer passionate about solving real-world problems through programming and logical thinking. Strong foundation in data structures and algorithms with 1000+ LeetCode problems solved | 300+ GeeksForGeeks problems solved | Pupil in CodeForces | Actively learning Machine Learning and Deep Learning.
          </p>
